...
//                                                " FROM item " +
//                                                "WHERE id=?",itemEntityRowMapper,idInt);
//    }
//
//    @Override
//    public ItemEntity findItem(Integer idInt) {
//        return jdbcTemplate.queryForObject("SELECT * " +
//                                                " FROM item " +
//                                                "WHERE id=?",itemEntityRowMapper,idInt);
//    }
//
//    @Override
//    public Integer deleteItem(Integer idInt) {
