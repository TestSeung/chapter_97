...
class AirReservationServiceUnitTest {
    ...
    @Test
    void findUserFavoritePlaceTicketsCase1() throws InvalidValueException, NotFoundException {
        //given
        Integer userId = 5;
        String likePlace = "파리";
    ...
    @Test
    void findUserFavoritePlaceTicketsCase2() throws InvalidValueException, NotFoundException {
        //given
        Integer userId = 5;
        String likePlace = "파리";
        String ticketType ="왕";
